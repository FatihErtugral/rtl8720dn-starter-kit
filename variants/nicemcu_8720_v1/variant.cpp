...
PinDescription g_APinDescription[TOTAL_GPIO_PIN_NUM] =
{
    ...
    {PB_1,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_ADC | PIO_UART,                                         MODE_NOT_INITIAL},

    // D5 - PB_2: LP_UART_TX, ADC5
    {PB_2,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_ADC | PIO_UART,                                         MODE_NOT_INITIAL},

    // D6 - PB_3: ADC6, SWD_CLK
    {PB_3,  TYPE_DIGITAL | TYPE_ANALOG, PIO_GPIO | PIO_GPIO_IRQ | PIO_ADC,                                                    MODE_NOT_INITIAL},

    // D7 - PA_25: LP_I2C_SCL, HS_PWM4, IR_TX
    {PA_25, TYPE_DIGITAL,               PIO_GPIO | PIO_GPIO_IRQ | PIO_PWM | PIO_IR | PIO_I2C,                                 MODE_NOT_INITIAL},

    // D8 - PA_26: LP_I2C_SDA, HS_PWM5, IR_RX
